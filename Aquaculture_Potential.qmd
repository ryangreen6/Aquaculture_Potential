...
In this project, I will identify the most suitable Exclusive Economic Zones (EEZ) on the West Coast of the US for developing marine aquaculture for oysters and Pacific herring (*Clupea pallasii*). Ideal EEZs will be determined based on the range of suitable Sea Surface Temperatures (SST) and depth ranges for each. 

A function will also be made to find suitable EEZs on the West Coast for any species desired. 
